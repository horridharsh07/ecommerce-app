...
export default function Login() {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 sm:px-8">
      <div className="w-full max-w-md animate-slide-up">
        <h1 className="font-serif text-3xl sm:text-4xl mb-8 text-center font-light text-foreground">Welcome Back</h1>
        {error && (
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <button
            ...
            className="bg-foreground text-background py-4 text-xs font-sans uppercase tracking-[0.2em] mt-4 hover:bg-foreground/90 transition-colors btn-press disabled:opacity-50 w-full"
          >
            {isLoading ? "Signing In..." : "Sign In"}
          </button>
        </form>
        <div className="flex justify-center items-center text-xs tracking-widest uppercase text-foreground/50 mt-8">
